...
filters_dict = {"u": "160", "g": "161", "r": "162", "i": "163", "z": "164", "y": "165"}

reporter = "Anais Moller, Emille E. O. Ishida, Julien Peloton on behalf of the Fink broker"
...
def extract_radec(data):
    ...
    ra.append(data['diaSource']['ra'])
    for alert in data['prvDiaSources']:
        ra.append(alert['ra'])
    ra = np.array(ra)

    dec.append(data['diaSource']['dec'])
    for alert in data['prvDiaSources']:
